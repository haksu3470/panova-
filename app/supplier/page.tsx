...
export default function SupplierCandidateRegister() {
  ...
  return (
    <div className={`min-h-screen bg-slate-900 text-slate-100 py-12 px-4 ${isRtl ? 'rtl' : 'ltr'}`} dir={isRtl ? 'rtl' : 'ltr'}>
        ...
        <div className="bg-slate-800 p-8 rounded-3xl border border-slate-700 shadow-2xl">
          ...
          {submitted ? (
            <div className="bg-emerald-950 p-6 rounded-2xl text-center space-y-3">
              ...
              <button onClick={() => setSubmitted(false)} className="bg-[#2e7d32] text-white px-5 py-2 rounded-xl text-xs font-bold cursor-pointer">Yeni Aday Kaydet</button>
            </div>
          ) : (
